<script setup lang="ts">
  import { Sphere, Stars } from '@tresjs/cientos';
  import { onMounted } from 'vue';
  import { Asteroid, AsteroidSchema, OrbitalDataSchema } from '../asteroid';
  ...
  onMounted(() => {
    ...
    const circleOutline3 = calculateOutline(
      {
        orbital_data: OrbitalDataSchema.parse({
          eccentricity: '.016551775261966',
          inclination: '.002870921763966',
          semi_major_axis: '1.0',
          perihelion_argument: '322.9679801896928',
          ascending_node_longitude: '138.6474466722698',
        }),
      },
      { color: 0x0000ff }
    );
    ...
    scene.value.add(circleOutline3);
  });
</script>
